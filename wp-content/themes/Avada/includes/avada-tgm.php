...
function avada_register_required_plugins() {
	...
	$config = array(
		...
		'strings'         	=> array(
			...
			'notice_can_install_required'     => _n_noop( 'This theme requires the following plugin installed or update: %1$s.', 'This theme requires the following plugins installed or updated: %1$s.', 'Avada' ), // %1$s = plugin name(s)
