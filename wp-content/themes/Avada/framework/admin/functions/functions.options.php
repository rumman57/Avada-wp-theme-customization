	...
	function of_options_array()
	{
	   ...
	   $of_options[] = array( "name" => __("User Login Shortcodes", "Avada"),
		...
		$of_options[] = array( "name" => __("Blog Page Title", "Avada"),
			"desc" => __("This text will display in the page title bar of the assigned blog page. Note: This option only works, if the blog page is not a static page.", "Avada"),
			"id" => "blog_title",
			"std" => "Blog",
			"type" => "text");

		$of_options[] = array( "name" => __("Blog Page Subtitle", "Avada"),
			"desc" => __("This text will display as subheading in the page title bar of the assigned blog page. Note: This option only works, if the blog page is not a static page.", "Avada"),
			"id" => "blog_subtitle",
			"std" => "",
			"type" => "text");
